...
Data was generated using **3 different methods** as required. Each table contains at least **500 records**. Two tables (Maintenance and PartUsage) contain **20,000 records** each. **Total: 43,500 records.**
...
|-------|---------|-------------------|----------|
| Location | 500 | Generatedata | `generatedataFiles/Location.sql` |
| Supplier | 500 | Mockaroo | `mockarooFiles/Supplier.sql` |
...
| MaintenanceContract | 500 | Generatedata | `generatedataFiles/MaintenanceContract.sql` |
| Maintenance | 20,000 | Python | `Programing/Maintenance_Insert.sql` |
| PartUsage | 20,000 | Python | `Programing/PartUsage_Insert.sql` |
| EquipmentContract | 500 | Generatedata | `generatedataFiles/EquipmentContract.sql` |
| **Total** | **43,500** | | |
